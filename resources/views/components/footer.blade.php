    ...
    <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                    <a href="#el-tiempo" class="text-reset">El tiempo</a>
                </p>
                <p>
                    <a href="#noticias" class="text-reset">Noticias</a>
                </p>
                <p>
                    <a href="#consejos" class="text-reset">Consejos</a>
                </p>
                <p>
                    <a href="#que-hace-la-dc" class="text-reset">¿Que hace la Defensa Civil?</a>
                </p>
            </div>
